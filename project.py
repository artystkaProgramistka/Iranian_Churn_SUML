...
if selected_option == "Informacje o Aplikacji":
    ...
    with tab6:
        ...
        try:
            ...
            subscription_length = st.number_input("Długość subskrypcji (miesiące)", min_value=0, max_value=120, step=1,
                                                  value=12)
            ...
            distinct_called_numbers = st.number_input("Liczba odrębnych połączeń", min_value=0, max_value=100, step=1,
                                                      value=10)
            frequency_of_use = st.number_input("Częstotliwość użytkowania", min_value=0, max_value=500, step=1,
                                               value=30)
            seconds_of_use = st.number_input("Czas użytkowania (sekundy)", min_value=0, max_value=100000, step=100,
                                             value=1000)
